...
model_path = "my_model.h5"  # Đường dẫn tới file mô hình đã tải xuống
...
def connect_to_database():
    ...
    connection_string = "DRIVER={SQL Server};SERVER=ADMIN-PC\SQLEXPRESS;DATABASE=dulieudotquy;UID=sa;PWD=sa2012"
